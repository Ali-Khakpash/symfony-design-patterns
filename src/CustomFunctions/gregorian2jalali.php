...
class gregorian2jalali
{
    ...
    /*    public function __construct($year, $month, $day, $d){
            $this->year = $year;
            $this->month = $month;
            $this->day = $day;
            $this->d= $d;
    ...
    function Get_Date() {
        ...
        return $this->year."-".$this->month."-".$this->day."-".$this->d;
    }
    ...
    function gregorian_to_jalali ($format="yy/mm/dd")
    {
